                        ...
                        <div class="card custom text border-0" style="border-radius: 2rem;">
                            <div class="card-body ps-4 pe-5 ">
                                ...
                                <div class="mb-md-5 ">
                                    ...
                                    <p class=" mb-2 text-uppercase text-center fs-1">Login</p>
                                    @if (Session::has('failed'))
                                        <div class="alert alert-danger">{{ Session::get('failed') }}</div>
                                    @endif
                                    <div class="form-outline form-white mb-4 fs-4">
                                        <label class="form-label ml-3" for="username">Email</label>
                                        <div class="d-flex border-bottom rounded-0 border-secondary">
                                            ...
                                            <input type="text" name="email"
                                                ...
                                                placeholder="Enter your email here" style="background-color: #1E3668; "
                                                required>
                                    ...
                                    <div class="form-outline form-white mb- fs-4">
                                    ...
                                    <div class="fs-6 mb-5 text-end mt-1">

                                        <a href="" class="text-decoration-none" style="color: #ACDDFD;">Forgot
                                            Password</a>
                                    </div>
                                ...
                                <div class="pt-5">
                                    <p class="mb-0">Don’t have an account? <a href="{{ url('/') }}/signup"
                                            ...
                                            style="color: #393939;">Sign Up now!</a>
                                    </p>
                                </div>
